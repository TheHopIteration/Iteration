                    ...
                    <div className="xl:w-3/12 lg:w-4/12 md:w-5/12 bg-white rounded-lg">
                        <form className='bg-white p-4 rounded-lg border-2 border-gray-200 shadow-lg'>
                            ...
                            <div className="mb-6">
                                <input
                                    type="text"
                                    className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-custom-darkcoral focus:outline-none"
